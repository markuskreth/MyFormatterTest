...
public class BoldFontDecorator extends PrintableStringDecorator.AbstractPrintableStringDecorator {

   @Override
   public void print(AttributedString as, String text, Graphics graphics, int posX, int posY) {
      Font font = graphics.getFont();
      Font myFont = new Font(font.getFontName(),  Font.BOLD|font.getStyle(), font.getSize());
